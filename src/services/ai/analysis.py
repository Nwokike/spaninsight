...
async def suggest(
    ...
    system_prompt = (
        ...
        "- The execution environment supports: pandas, numpy, matplotlib.pyplot, math, datetime, statistics (Python standard library), shapely, pymongo, jq, and pendulum.\n"
...
async def generate_code(
    ...
    system_prompt = (
        ...
        "  7. pymongo (MongoDB NoSQL connection/queries)\n"
        "  8. jq (JSON slicing and cleaning)\n"
        "  9. pendulum (advanced datetime parsing and manipulations)\n\n"
