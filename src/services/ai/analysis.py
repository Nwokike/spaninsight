...
async def generate_code(
    ...
    system_prompt = (
        ...
        "- IMPORTANT: Always use `.dropna()` or `.fillna()` before performing algebraic, matrix, or statistical operations (like PCA or correlation) to prevent LAPACK C-level errors.\n"
        "- For plotting, ALWAYS create a figure explicitly.\n"
